...
if __name__ == "__main__":
    ...
    if cfg.DATA_DIR.find('lsun') != -1:
        ...
        from datasets import TextDataset# words datasets
    ...
    if cfg.TRAIN.FLAG:
        ...
        if cfg.B_VALIDATION:
            algo.evaluate(split_dir)  # generate images for the whole valid dataset
        else:
            algo.gen_example(cfg.CAPTIONS_PATH)  # generate images for customized captions
    end_t = time.time()
